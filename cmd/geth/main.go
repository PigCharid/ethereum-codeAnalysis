//版权所有2014 The go ethereum Authors
//此文件是go ethereum的一部分。
//
//go ethereum是免费软件：您可以重新发布和/或修改它
//它是根据GNU通用公共许可证的条款发布的
//自由软件基金会，许可证版本3，或
//（由您选择）任何更高版本。
//
//go ethereum的发布是为了希望它会有用，
//但无任何保证；甚至没有暗示的担保
//适销性或对特定目的的适合性。请参阅
//GNU通用公共许可证了解更多详细信息。
//
//您应该已经收到GNU通用公共许可证的副本
//还有去以太坊。如果没有，请参阅<http://www.gnu.org/licenses/>.
//geth是以太坊的官方命令行客户端。
package main
...
const (
	clientIdentifier = "geth" //要在网络上公布的客户端标识符
)
